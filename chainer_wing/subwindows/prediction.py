...
class Ui_PredictionWindow(object):
    def setupUi(self, PredictionWindow):
        ...
        self.input_sel_button.setEnabled(True)
        ...
        self.including_label = QtWidgets.QCheckBox(self.prediction_widget)
        self.including_label.setObjectName("including_label")
        self.verticalLayout_6.addWidget(self.including_label)
        self.select_by_dir = QtWidgets.QCheckBox(self.prediction_widget)
        self.select_by_dir.setEnabled(True)
        self.select_by_dir.setObjectName("select_by_dir")
        self.verticalLayout_6.addWidget(self.select_by_dir)
    ...
    def retranslateUi(self, PredictionWindow):
        ...
        self.select_by_dir.setText(_translate("PredictionWindow", "Select Input Data by Directory"))
